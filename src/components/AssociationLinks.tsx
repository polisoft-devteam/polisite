...
// album, the Drive folder, the repository.
//
// Only rendered for active members. The album and folder are shared "anyone with the
        ...
        {links.map((link) => {
          ...
          return (
            <li key={link.id} className="p-3">
              <ExternalLink href={link.url} className="flex items-center gap-3">
