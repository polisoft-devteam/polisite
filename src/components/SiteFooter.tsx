...
export function SiteFooter() {
  ...
  return (
    <footer className="mt-16 border-t">
      <div className="text-muted-foreground mx-auto flex w-full max-w-6xl flex-col gap-2 px-4 py-8 pb-24 text-sm sm:flex-row sm:items-center sm:justify-between md:pb-8 2xl:max-w-7xl">
